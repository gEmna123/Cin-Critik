...
* Utilisation de PDO et requêtes préparées pour sécuriser les accès à la base de données
...
│
└── admin/
    └── test_bd.sql           # Script de création de la base
```
